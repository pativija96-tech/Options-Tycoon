...
STRATEGY_MATRIX = {
    ...
    ("bearish", "low", "high"): "bear_put_spread_small",
    ("bearish", "low", "normal"): "bear_put_spread_small",
    ("bearish", "low", "low"): "bear_put_spread_small",
    ...
    ("bullish", "low", "high"): "bull_call_spread_small",
    ("bullish", "low", "normal"): "bull_call_spread_small",
    ("bullish", "low", "low"): "bull_call_spread_small",
    ...
    ("neutral", "low", "high"): "iron_condor",
    ("neutral", "low", "normal"): "iron_condor",
    ("neutral", "low", "low"): "iron_condor",
}
